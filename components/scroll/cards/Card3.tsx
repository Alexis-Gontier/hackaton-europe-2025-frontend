...
export default function Card3() {
  return (
    <Card
      className="relative w-full h-[calc(100vh-200px)] rounded-4xl bg-clip-padding bg-gradient-to-t from-[#FF00D0] to-[#FF1500] p-2 after:content-[''] after:absolute after:inset-0 after:rounded-4xl after:shadow-[0_0_10px_5px_rgba(255,21,0,0.5)]"
    >
      <CardContent className="w-full h-full rounded-3xl bg-white p-6 flex flex-col gap-8">
